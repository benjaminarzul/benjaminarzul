...
var togafquizzApp = angular.module('togafquizzApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'togafquizzAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
