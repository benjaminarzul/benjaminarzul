...
import fr.softeam.togafquizz.domain.PersistentToken;
import fr.softeam.togafquizz.domain.User;
import fr.softeam.togafquizz.repository.PersistentTokenRepository;
import fr.softeam.togafquizz.repository.UserRepository;
import fr.softeam.togafquizz.security.SecurityUtils;
import fr.softeam.togafquizz.service.MailService;
import fr.softeam.togafquizz.service.UserService;
import fr.softeam.togafquizz.web.rest.dto.UserDTO;
...
public class AccountResource {
	...
	public ResponseEntity<?> registerAccount(
		...
		if (user != null) {
			...
			user = userService.createUserInformation(userDTO.getLogin(),
					...
					userDTO.getLastName(), userDTO.getSociety(),
	...
	public ResponseEntity<UserDTO> getAccount() {
		...
		return new ResponseEntity<>(new UserDTO(user.getLogin(), null,
				user.getFirstName(), user.getLastName(), user.getSociety(),
				user.getEmail(), user.getLangKey(), roles), HttpStatus.OK);
	}
	...
	public ResponseEntity<String> saveAccount(@RequestBody UserDTO userDTO) {
		...
		userService
				.updateUserInformation(userDTO.getFirstName(),
						userDTO.getLastName(), userDTO.getSociety(),
						userDTO.getEmail());
