...
public class QuizzResource {
     ...
     */
    @RequestMapping(value = "/quizzs/{id}",
            method = RequestMethod.GET,
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Quizz> get(@PathVariable Long id, HttpServletResponse response) {
     ...
     */
    @RequestMapping(value = "/quizzs/upload",
            method = RequestMethod.POST,
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
...
//        try {
//        	BufferedReader in = new BufferedReader(new InputStreamReader(uploadFile));
